...
public abstract class AbstractLayeredBoard<E extends CharElements> implements ClientBoard {
    ...
    protected Point pt(int x, int y) {
    ...
    /**
     * Says if near (at left, right, down, up, left-down, left-up, right-down,
     * right-up) given position (X, Y) at given layer exists given element.
     *
     * @param numLayer Layer number (from 0).
     * @param x        X coordinate.
     * @param y        Y coordinate.
     ...
     * @param y        Y coordinate.
     * @param element  Element that we try to detect on near point.
     * @return Returns count of elements with type specified near (at left, right,
     *         down, up, left-down, left-up, right-down, right-up) {x,y} point.
     */
     ...
     * @param x        X coordinate.
     * @param y        Y coordinate.
     * @return All elements around (at left, right, down, up, left-down, left-up,
     *         right-down, right-up) position.
     */
