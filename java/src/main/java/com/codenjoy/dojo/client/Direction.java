...
public enum Direction {
    ...
    public Direction inverted() {
        switch (this) {
            ...
            default: throw new IllegalArgumentException("Cant invert for: " + this);
        }
    }
    ...
    public Direction clockwise() {
        switch (this) {
            ...
            default: throw new IllegalArgumentException("Cant clockwise for: " + this);
        }
    }
    ...
    public Direction counterClockwise() {
        switch (this) {
            ...
            case UP: return LEFT;
            default: throw new IllegalArgumentException("Cant counter clockwise for: " + this);
        }
    }
